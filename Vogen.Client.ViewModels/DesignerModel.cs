...
namespace Vogen.Client.ViewModels
{
    public static class DesignerModel
    {
        ...
        static DesignerModel()
        {
            ...
            var tracks = Util.Array.ofParams(
                new Track("Track 1"),
                new Track("Track 2"),
                new Track("Track 3"),
                new Track("Track 4"));
            ...
            ActiveComp = new Composition(
                ...
                tracks,
                Util.Array.ofParams<PartBase>(
                    new DryVocalPart(new MidiClock(1920), tracks[0], GetSampleDryVocal()),
                    new NotePart(new MidiClock(1440), tracks[1], "Notes", "wuu-sz",
                    ...
                    new NotePart(new MidiClock(1920), tracks[2], "Notes", "wuu-sz",
                        notes: Util.Array.ofParams(
                    ...
                    new NotePart(new MidiClock(960), tracks[3], "Notes", "wuu-sz",
                        notes: Util.Array.ofParams(
                    ...
                    new NotePart(new MidiClock(1920), tracks[3], "Notes", "wuu-sz",
                        notes: Util.Array.ofParams(
