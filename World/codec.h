...
//-----------------------------------------------------------------------------
WORLD_API int GetNumberOfAperiodicities(int fs);
...
//-----------------------------------------------------------------------------
WORLD_API void CodeAperiodicity(const double* const* aperiodicity, int f0_length,
...
//-----------------------------------------------------------------------------
WORLD_API void DecodeAperiodicity(const double* const* coded_aperiodicity,
...
//-----------------------------------------------------------------------------
WORLD_API void CodeSpectralEnvelope(const double* const* spectrogram, int f0_length,
...
//   spectrogram
//-----------------------------------------------------------------------------
WORLD_API void DecodeSpectralEnvelope(const double* const* coded_spectral_envelope,
