...
//   f0                   : F0 contour.
//-----------------------------------------------------------------------------
WORLD_API void Dio(const double* x, int x_length, int fs, const DioOption* option,
...
//-----------------------------------------------------------------------------
WORLD_API void InitializeDioOption(DioOption* option);
...
//-----------------------------------------------------------------------------
WORLD_API int GetSamplesForDIO(int fs, int x_length, double frame_period);
